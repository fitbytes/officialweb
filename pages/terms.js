...
return (
 <div>
  <h1 style={{color:"tomato",textAlign:"center"}}>TERMS OF SERVICE<i>@fitbytes</i></h1>
   ...
   <ul>
    ...
    <li>
    <p><strong>Company</strong> referred to as either the Company, We , Us or Our in this Agreementrefers to Fitbytes.</p>
    </li>
    <li>
    ...
    <li>
    <p><strong>Website</strong> refers to Fitbytes, accessible from fitbytes.github.io</p>
    </li>
    <li>
    ...
    <p>If You are a copyright owner, or authorized on behalf of one, and You believe that the copyrighted work has been copied in a way that constitutes copyright infringement that is taking place through the Service, You must submit Your notice in writing to the attention of our copyright agent via email  and include in Your notice a detailed description of the alleged infringement.</p>
    ...
    <p>Notwithstanding any damages that You might incur, the entire liability of the Company and any of its suppliers under any provision of this Terms and Your exclusive remedy for all of the foregoing shall be limited to the amount actually paid by You through the Service or 100 USD if You havent purchased anything through the Service.</p>
    ...
    <p>Some states do not allow the exclusion of implied warranties or limitation of liability for incidental or consequential damages, which means that some of the above limitations may not apply. In these states, each partys liability will be limited to the greatest extent permitted by law.</p>
    ...
    <p>Without limiting the foregoing, neither the Company nor any of the companys  provider makes any representation or warranty of any kind, express or implied  i as to the operation or availability of the Service, or the information, content, and materials or products included thereon; ii that the Service will be uninterrupted or error-free iii as to the accuracy, reliability, or currency of any information or content provided through the Service or iv that the Service, its servers, the content, or e-mails sent from or on behalf of the Company are free of viruses, scripts, trojan horses, worms, malware, timebombs or other harmful components.</p>
    ...
    <p>Except as provided herein, the failure to exercise a right or to require performance of an obligation under these Terms shall not effect a partys ability to exercise such right or require such performance at any time thereafter nor shall be the waiver of a breach constitute a waiver of any subsequent breach.</p>
